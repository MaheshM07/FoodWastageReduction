...
public class OrganizationHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_charityorganizationhome);
    ...
    public void initializeUIComponents()
    {
        ...
        optionsRG.check(R.id.editprofile);
    }
    ...
    public void next(View view)
    {
        ...
        Intent i = null;
        if (selectedOption == R.id.editprofile)
        {
        ...
        else if(selectedOption==R.id.givefeedback)
        {
            ...
            ArrayList<Restaurant> restaurantList = databaseHelper.getApprovedRestaurantList();
            if (restaurantList.size()>0)
            {
                i=new Intent(getApplicationContext(),GiveFeedbackActivity.class);
            }
            else {
                Toast.makeText(getApplicationContext(),Constants.NO_RESTAURANTS_FOR_FEEDBACK,Toast.LENGTH_LONG).show();
                return;
            }
        }
