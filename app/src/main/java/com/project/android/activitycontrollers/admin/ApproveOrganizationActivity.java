...
public class ApproveOrganizationActivity extends AppCompatActivity {
    private TextView nameTV, mailTV, mobileTV,addressTV;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_approveorganization);
        initializeUIComponents();
        organization_ID = getIntent().getLongExtra(Constants.ID_KEY, 0);
    ...
    public void displayData()
    {
        ...
        organization = databaseHelper.getOrganizationWithId(organization_ID);

        if (organization != null)
        {

            nameTV.setText(organization.getOrganizationname());
            mailTV.setText(organization.getEmail());
            mobileTV.setText(organization.getPhno());
            addressTV.setText(String.valueOf(organization.getAddress()));
            String path = organization.getProfilePath();
        ...
        {
            Toast.makeText(getApplicationContext(), Constants.NO_ORGANIZATION_WITH_NAME, Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void approve(View view)
    {
        ...
        databaseHelper.updateOrganizationStatus(organization);
        Toast.makeText(getApplicationContext(), Constants.ORGANIZATION_APPROVED_SUCCESSFULLY, Toast.LENGTH_SHORT).show();
        finish();
        ...
        {
            sendSms(organization.getPhno(),  "Admin has approved your registration request using  Food Wastage Reduction Through Donation App.");
