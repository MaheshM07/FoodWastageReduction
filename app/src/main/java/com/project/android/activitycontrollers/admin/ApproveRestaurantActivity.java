...
public class ApproveRestaurantActivity  extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_approverestaurant);
        initializeUIComponents();
        restaurant_ID = getIntent().getLongExtra(Constants.ID_KEY, 0);
    ...
    public void displayData()
    {
        ...
        restaurant = databaseHelper.getRestaurantWithId(restaurant_ID);
        ...
        if (restaurant != null)
        {
            ...
            addressTV.setText(String.valueOf(restaurant.getAddress()));
        ...
        {
            Toast.makeText(getApplicationContext(), Constants.NO_RESTAURANT_WITH_NAME, Toast.LENGTH_LONG).show();
        }
    }
    public void approve(View view)
    {
        ...
        databaseHelper.updateRestaurantStatus(restaurant);
        Toast.makeText(getApplicationContext(), Constants.RESTAURANT_APPROVED_SUCCESSFULLY, Toast.LENGTH_SHORT).show();
        finish();
        ...
        {
            sendSms(restaurant.getPhno(),  "Admin has approved your registration request using  Food Wastage Reduction Through Donation App.");
