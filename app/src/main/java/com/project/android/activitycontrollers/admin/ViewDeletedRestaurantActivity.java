...
public class ViewDeletedRestaurantActivity extends AppCompatActivity {
    private ListView listView = null;

    RestaurantListItemAdapter customAdapter;
    ...
    public void populateListView() {
        ...
        mNoRestaurantsView.setText(Constants.NODELETEDRESTAURANTS_DESCRIPTION);

        final AppDatabaseHelper databaseHelper = new AppDatabaseHelper(this);

        restaurantList = databaseHelper.getDeletedRestaurantList();
        if (restaurantList.size() > 0) {
            mNoRestaurantsView.setVisibility(View.GONE);
            customAdapter = new RestaurantListItemAdapter(this, R.layout.allrestaurantslist_item);
