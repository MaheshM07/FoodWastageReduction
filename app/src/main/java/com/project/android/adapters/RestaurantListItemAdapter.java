...
public class RestaurantListItemAdapter extends ArrayAdapter<Restaurant>
{
    private Activity context;
    List<Restaurant> restaurantList;
    LayoutInflater inflater;

    public RestaurantListItemAdapter(Activity context, int resourceId)
    {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.allrestaurantslist_item, null);
