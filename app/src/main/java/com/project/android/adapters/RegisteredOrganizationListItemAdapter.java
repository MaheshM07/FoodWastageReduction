...
public class RegisteredOrganizationListItemAdapter extends ArrayAdapter<Organization> {
    private Activity context;
    List<Organization> organizationList;
    LayoutInflater inflater;

    public RegisteredOrganizationListItemAdapter(Activity context, int resourceId)
    {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        final RegisteredOrganizationListItemAdapter.ViewHolder holder;
        if (view == null) {
            holder = new RegisteredOrganizationListItemAdapter.ViewHolder();
            view = inflater.inflate(R.layout.registeredorganizationslist_item, null);
        ...
        {
            holder = (RegisteredOrganizationListItemAdapter.ViewHolder) view.getTag();
        }
